...
{
	public IResourceBuilder<MongoDBDatabaseResource> Database { get; private set; } = default!;
	public IResourceBuilder<MongoDBDatabaseResource> SharedQueryDatabase { get; private set; } = default!;
